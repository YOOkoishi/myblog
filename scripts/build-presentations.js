...
/* 修复：嵌套结构子页面（H2级别）中的列表需要额外的左边距 */
/* 因为容器已有 padding-left: 80px，列表的 padding-left: 30px 相对于容器 */
/* 为了让列表项看起来不会太靠左，给列表添加额外的 margin-left */
.reveal .slides > section > section:not(.title-slide):not(#title-slide) ul,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) ol {
...
/* 嵌套列表（二级、三级列表）的样式 */
.reveal .slides > section > section:not(.title-slide):not(#title-slide) ul ul,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) ul ol,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) ol ul,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) ol ol {
  margin-left: 70px !important;
  padding-left: 30px !important;
}
