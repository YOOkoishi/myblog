...
/* 扁平结构的内容 */
/* 排除列表元素(ul, ol)，因为列表有自己的 padding 规则 */
.reveal .slides > section.title-slide.slide.level1 > *:not(h1):not(ul):not(ol) {
...
/* 嵌套结构父标题页的内容 */
/* 排除列表元素(ul, ol)，因为列表有自己的 padding 规则 */
.reveal .slides > section > section.title-slide.slide.level1 > *:not(h1):not(ul):not(ol) {
  padding-left: 80px !important;
  padding-right: 80px !important;
}
...
/* 嵌套结构的内容区域包装器 */
/* 排除列表元素(ul, ol)，因为列表有自己的 padding 规则 */
.reveal .slides > section > section:not(.title-slide):not(#title-slide) > *:not(h2):not(ul):not(ol) {
  padding-left: 80px !important;
  padding-right: 80px !important;
}
...
/* 
 * 统一所有模式下列表距离左边缘的视觉距离
 * 目标：无论是扁平结构、嵌套结构、H1页面还是H2页面，列表项距离左边缘的距离保持一致
 */
...
/* 1. 扁平结构（只有H1，没有H2子页面）的列表 */
/* 这些列表现在不会从通用规则获得 padding-left: 80px，需要手动添加 margin-left: 80px */
...
/* 2. 扁平结构中 H1 后第一个 H2 (first-subsection) 的列表 */
/* 这个 div 也有 padding-left: 80px，所以列表使用相同的 40px */
.reveal .slides section.title-slide.slide.level1 .first-subsection ul,
.reveal .slides section.title-slide.slide.level1 .first-subsection ol {
  padding-left: 40px !important;
  margin-left: 0 !important;
}

/* 3. 嵌套结构的父标题页（H1级别）的列表 */
/* 列表现在不会从通用规则获得 padding-left: 80px，需要手动添加 margin-left: 80px */
...
/* 5. 所有二级、三级嵌套列表（ul ul, ol ol, ul ol, ol ul）*/
/* 这些列表相对于父列表，使用标准的 30px 缩进 */
...
/* ===== 文本对齐样式类 ===== */
/* 这些类可以在 Markdown 中使用 ::: {.class-name} 语法 */

/* 基础对齐类 - 使用高优先级选择器 */
.reveal .slides section .text-left,
...
.reveal .slides section .text-right,
.reveal .slides .text-right,
.text-right {
  text-align: right !important;
}

.reveal .slides section .text-justify,
.reveal .slides .text-justify,
.text-justify {
  text-align: justify !important;
}

/* 覆盖段落的默认左对齐 - 需要更高的优先级 */
.reveal .slides section .text-left p,
.reveal .slides section .text-left div,
.reveal .slides .text-left p,
.reveal .slides .text-left div,
.text-left p,
.text-left div {
  text-align: left !important;
}

.reveal .slides section .text-center p,
.reveal .slides section .text-center div,
.reveal .slides .text-center p,
.reveal .slides .text-center div,
.text-center p,
.text-center div {
  text-align: center !important;
}

.reveal .slides section .text-right p,
.reveal .slides section .text-right div,
.reveal .slides .text-right p,
.reveal .slides .text-right div,
.text-right p,
.text-right div {
  text-align: right !important;
}

.reveal .slides section .text-justify p,
.reveal .slides section .text-justify div,
.reveal .slides .text-justify p,
.reveal .slides .text-justify div,
.text-justify p,
.text-justify div {
  text-align: justify !important;
}
...
/* 列表对齐 */
.reveal .slides section .text-left ul,
.reveal .slides section .text-left ol,
.reveal .slides section .text-left li,
.text-left ul,
.text-left ol,
.text-left li {
  text-align: left !important;
...
.reveal .slides section .text-center ul,
.reveal .slides section .text-center ol,
.reveal .slides section .text-center li,
.text-center ul,
.text-center ol,
.text-center li {
  text-align: center !important;
...
.reveal .slides section .text-right ul,
.reveal .slides section .text-right ol,
.reveal .slides section .text-right li,
.text-right ul,
.text-right ol,
.text-right li {
  text-align: right !important;
...
.reveal .slides section .text-justify ul,
.reveal .slides section .text-justify ol,
.reveal .slides section .text-justify li,
.text-justify ul,
.text-justify ol,
.text-justify li {
  text-align: justify !important;
...
/* 内联样式支持 - 用于直接在元素上使用 style 属性 */
.reveal .slides section [style*="text-align: left"],
.reveal .slides [style*="text-align: left"] {
  text-align: left !important;
}

.reveal .slides section [style*="text-align: center"],
.reveal .slides [style*="text-align: center"] {
  text-align: center !important;
}

.reveal .slides section [style*="text-align: right"],
.reveal .slides [style*="text-align: right"] {
  text-align: right !important;
}

.reveal .slides section [style*="text-align: justify"],
.reveal .slides [style*="text-align: justify"] {
  text-align: justify !important;
}

/* 覆盖现有段落样式的左对齐设置 */
.reveal .slides > section:not(#title-slide) .text-center p,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) .text-center p {
  text-align: center !important;
}

.reveal .slides > section:not(#title-slide) .text-right p,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) .text-right p {
  text-align: right !important;
}

.reveal .slides > section:not(#title-slide) .text-justify p,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) .text-justify p {
  text-align: justify !important;
}

/* 最高优先级的段落对齐覆盖 - 确保段落样式被正确覆盖 */
.reveal .slides > section:not(#title-slide) p.text-center,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) p.text-center,
.reveal .slides section .text-center > p,
.reveal .slides .text-center > p {
  text-align: center !important;
}

.reveal .slides > section:not(#title-slide) p.text-right,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) p.text-right,
.reveal .slides section .text-right > p,
.reveal .slides .text-right > p {
  text-align: right !important;
}

.reveal .slides > section:not(#title-slide) p.text-left,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) p.text-left,
.reveal .slides section .text-left > p,
.reveal .slides .text-left > p {
  text-align: left !important;
}

.reveal .slides > section:not(#title-slide) p.text-justify,
.reveal .slides > section > section:not(.title-slide):not(#title-slide) p.text-justify,
.reveal .slides section .text-justify > p,
.reveal .slides .text-justify > p {
  text-align: justify !important;
}
