...
- **Stack Overflow 调查**: 始终稳居最受欢迎编辑器前列 (Top 3)
- **Linux 世界**: 几乎所有服务器的默认编辑器 (`vi`)
- **极客首选**: 许多顶级开源项目的维护者都在用

> "I use Vim because I can't figure out how to exit." —— 这是一个梗，但也说明了它的门槛。
...
- **普通编辑器**: 鼠标定位 -> 选中 -> 删掉 -> 输入
- **Vim**: `dw` (Delete Word), `c$` (Change to end of line)
- **思考速度**: 当操作跟上思维，编码就是一种享受
- **健康**: 减少鼠标手 (RSI) 风险
